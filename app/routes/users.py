...
from app.routes.auth import( is_email_or_username_taken,get_current_user,
        create_access_token, get_password_hash,authenticate_user)
from app.schemas.auth import Token

user_route = APIRouter()

@user_route.post("/user", tags=['User Auth'])
...
@user_route.post("/login", tags=['User Auth'] )
...
@user_route.get("/user", response_model=schemas.User,tags=['view'])
